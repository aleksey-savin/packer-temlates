...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "sudo apt-get install postgrespro-std-16-contrib",
      "sudo /opt/pgpro/std-16/bin/pg-setup initdb --tune=1c",
      "sudo /opt/pgpro/std-16/bin/pg-setup service enable",
      "sudo /opt/pgpro/std-16/bin/pg-setup service start"
